...
faq:
  - question: "Why is YouTube so addictive compared to other platforms?"
    answer: "YouTube combines several powerful addictive elements: an autoplay feature that removes stopping points, an algorithm that learns exactly what keeps you watching, variable-length content that creates flow state, and the psychological investment of 'just one more video.' Together, these create what researchers call a 'super-stimulus' for the brain's reward system."
  - question: "Can I still watch YouTube without binge watching?"
    answer: "Absolutely. The problem isn't YouTube itself—it's mindless, infinite watching. By turning off autoplay, setting time limits before you start, and watching intentionally rather than passively, you can enjoy valuable content while avoiding the binge-watching trap."
  - question: "How do I break the YouTube autoplay addiction?"
    answer: "Turn off autoplay immediately (Settings > Autoplay > Off). Then set a time limit before watching (e.g., 'I'll watch for 30 minutes'). When time's up, close YouTube immediately—even mid-video. This re-trains your brain that sessions have boundaries."
  - question: "Why do I say 'just one more video' but watch for hours?"
    answer: "This is called 'hyperbolic discounting'—your brain values immediate reward (one more video) over delayed benefits (stopping now). YouTube's autoplay feature exploits this by removing decision points. Breaking the pattern requires creating deliberate stopping points before you start watching."
  - question: "Is binge watching YouTube videos actually harmful?"
    answer: "Excessive YouTube use can harm sleep, reduce productivity, contribute to sedentary behavior, and create feelings of guilt and wasted time. However, YouTube also provides valuable educational content and entertainment. The key is intentional, bounded use rather than mindless bingeing."
  - question: "How long does it take to break a YouTube binge-watching habit?"
    answer: "Most people notice significant reduction in automatic binge-watching within 2-3 weeks of turning off autoplay and setting time limits. Lasting habit change typically takes 60-90 days of consistent practice with intentional viewing strategies."
---
