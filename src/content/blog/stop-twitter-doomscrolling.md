...
faq:
  - question: "What is doomscrolling and why does Twitter cause it?"
    answer: "Doomscrolling is the compulsive urge to scroll through negative news and content, even though it makes you feel worse. Twitter is particularly prone to this because its real-time nature, outrage-driven engagement algorithm, and infinite scroll create a perfect storm of anxiety and addiction. The platform is literally designed to keep you angry and engaged."
  - question: "Can I use Twitter without doomscrolling?"
    answer: "Yes. The problem isn't Twitter itself—it's mindless, reactive use. By setting time limits, curating your feed ruthlessly, turning off retweets, and using mindful interventions, you can use Twitter intentionally for networking and information while avoiding the doomscrolling trap."
  - question: "How long should I spend on Twitter per day?"
    answer: "Most people find 20-30 minutes daily (in 2-3 sessions of 10 minutes each) sufficient for Twitter's benefits without significant mental health impact. The key is scheduling these sessions rather than checking randomly, and keeping them strictly bounded by time."
  - question: "Why does Twitter make me feel so anxious and angry?"
    answer: "Twitter's algorithm prioritizes content that generates strong emotional reactions—especially anger and outrage. This isn't a bug; it's a feature. Engagement drives revenue, and nothing drives engagement like making people upset. Additionally, the constant stream of negative news and social comparison creates a persistent background anxiety."
  - question: "Should I just delete Twitter to protect my mental health?"
    answer: "Deleting Twitter is one valid option, but not the only one. Many people find value in Twitter for networking, news, and community. If you choose to keep it, focus on making your experience intentional and bounded: strict time limits, ruthless feed curation, scheduled checking only, and regular mental health check-ins."
  - question: "How long does it take to break a Twitter doomscrolling habit?"
    answer: "Most people notice significant reduction in automatic checking within 1-2 weeks of turning off notifications and setting time limits. The urge to doomscroll typically fades after 3-4 weeks of consistent practice with intentional use strategies. Full habit transformation takes 60-90 days."
---
